...
/* Surface Flags */
#define DotFlag         0x01     /* Dot Surface                */
#define AllSurfaceFlag  0xFF     /* All Surfaces               */
...
int CreateBond( Long, Long, int );
int ChangeBondOrder( Long, Long, int, int );
int CreateNewBond( Long, Long );
