...
/* Cursor Mode */
#define CURRasmol    0x01
#define CURPicking   0x02
#define CURPickplus  0x03
#define CURPickminus 0x04
...
extern int CmdBkgColor;
extern int CmdTxtColor;
extern int GUItoCmdEcho;
...
void ProcessWheelDial( double, int );
